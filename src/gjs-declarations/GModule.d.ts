...
declare module "gi://GModule" {
  namespace GModule {
    ...
    class Module {
       ...
       * #G_MODULE_EXPORT. Note that a valid symbol can be %NULL.
       *
    ...
    /**
     * Flags passed to {@link GModule.open}. Note that these flags are
    ...
    enum ModuleFlags {
       ...
       * global name space. The default action on most platforms is to
       * place symbols in the module in the global name space, which may
    ...
    /**
     * Specifies the type of the module initialization function. If a
     * module contains a function named {@link GModule.check_init} it is
     * called automatically when the module is loaded. It is passed the
     * #GModule structure and should return %NULL on success or a string
     * describing the initialization error.
     */
    interface ModuleCheckInit {
      /**
       * Specifies the type of the module initialization function. If a
       * module contains a function named {@link GModule.check_init} it
       * is called automatically when the module is loaded. It is passed
       * the #GModule structure and should return %NULL on success or a
       * string describing the initialization error.
       *
       * @param module The #GModule corresponding to the module which
     ...
     * {@link GModule.unload} it is called automatically when the module
     * is unloaded. It is passed the #GModule structure.
     */
     ...
     * be found. It can be %NULL or an empty string to indicate that the
     * module is in a standard platform-specific directory, though this
     * is not recommended since the wrong module may be found.
     *
     * For example, calling {@link GModule.build_path} on a Linux system
     * with a #directory of `/lib` and a #module_name of "mylibrary"
     * will return `/lib/libmylibrary.so`. On a Windows system, using
     ...
     *   %NULL or the empty string to indicate that the standard
     *   platform-specific directories will be used, though that is not
     *   recommended
     * @param module_name The name of the module
     * @returns The complete path of the module, including the standard
     *   library prefix and suffix. This should be freed when no longer
     *   needed
     */
