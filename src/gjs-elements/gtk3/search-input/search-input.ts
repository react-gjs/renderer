...
interface SearchInputInternalProps extends SearchInputProps {
  ...
  implements GjsElement<"SEARCH_INPUT", Gtk.SearchEntry>
{
  ...
  constructor(props: DiffedProps) {
    ...
    this.handlers.bind("search-changed", "onSearchChanged", () => ({
      text: this.widget.text,
    }));
    this.handlers.bind("stop-search", "onSearchStopped");
    this.handlers.bind("next-match", "onNextMatch");
    this.handlers.bind("previous-match", "onPreviousMatch");
